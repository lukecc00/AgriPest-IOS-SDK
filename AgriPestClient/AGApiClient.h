 ...
 */
extern NSString *const AGResponseObjectErrorKey;


@interface AGApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<AGConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<AGResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<AGSanitizer> sanitizer;
