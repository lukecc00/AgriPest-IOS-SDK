 ...
 */
extern NSString *const AGDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const AGTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const AGEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const AGUnknownResponseObjectErrorCode;

@protocol AGResponseDeserializer <NSObject>
...
@interface AGResponseDeserializer : NSObject <AGResponseDeserializer>
