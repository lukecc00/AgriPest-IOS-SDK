#import "AGResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const AGDeserializationErrorDomainKey = @"AGDeserializationErrorDomainKey";

NSInteger const AGTypeMismatchErrorCode = 143553;

NSInteger const AGEmptyValueOccurredErrorCode = 143509;

NSInteger const AGUnknownResponseObjectErrorCode = 143528;


@interface AGResponseDeserializer ()
...
@implementation AGResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:AGDeserializationErrorDomainKey code:AGTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:AGDeserializationErrorDomainKey code:AGEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:AGDeserializationErrorDomainKey code:AGUnknownResponseObjectErrorCode userInfo:userInfo];
}
