...
#import "AGBasicAuthTokenProvider.h"
#import "AGLogger.h"

@interface AGDefaultConfiguration ()
...
@implementation AGDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static AGDefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [AGBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
