#import "AGSanitizer.h"
#import "AGObject.h"
#import "AGQueryParamCollection.h"
#import "AGDefaultConfiguration.h"
#import <ISO8601/ISO8601.h>

NSString * const kAGApplicationJSONType = @"application/json";

NSString * AGPercentEscapedStringFromString(NSString *string) {
    static NSString * const kAGCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kAGCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kAGCharactersGeneralDelimitersToEncode stringByAppendingString:kAGCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[AGQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [AGSanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[AGObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [AGSanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [AGDefaultConfiguration sharedConfig].serializationTimeZone;
