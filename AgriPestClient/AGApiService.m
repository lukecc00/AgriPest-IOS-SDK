...
///  @param chatRequest  
///
///  @returns AGResultListDiagnosisItem*
///
-(NSURLSessionTask*) chatWithChatRequest: (AGChatRequest*) chatRequest
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultListDiagnosisItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultListDiagnosisItem*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteHistoryWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v1/agent/history/{id}"];
